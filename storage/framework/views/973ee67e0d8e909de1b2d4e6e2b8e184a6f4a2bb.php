...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      <form method="post" action="<?php echo e(url('perizinan/'.$perizinan->id.'/pengajuan-ijin')); ?>">
        <?php echo csrf_field(); ?>
        <div class="form-group">
          <label for="exampleInputEmail1">Kegiatan dan Pelatihan</label>
          <input type="text" class="form-control" value="<?php echo e($perizinan->kepel->kepel); ?>" required id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" disabled>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Jenis Perizinan</label>
          <input type="text" class="form-control" value="<?php echo e($jenis_perizinan[$perizinan->jenis_perizinan]); ?>" disabled required id="exampleInputPassword1" placeholder="Password">
        </div>
        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\ibip\resources\views/pengajuan.blade.php ENDPATH**/ ?>