...
<?php $__env->startSection('content'); ?>
   ...
   <div class="col-md-12">
      ...
      <div class="box box-primary">
         ...
         <!-- /.box-header -->
         <!-- form start -->
         <form role="form" method="POST" action="<?php echo e(route('users').'/'.$user->id); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="box-body">
               ...
               <div class="form-group <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
                  ...
                  <input type="text" class="form-control" value="<?php echo e($user->name); ?>" id="name" name="name">
                  <?php if($errors->has('name')): ?> <span class="help-block"><small>Tidak boleh kosong</small></span> <?php endif; ?>
               </div>

               <div class="form-group <?php if($errors->has('email')): ?> has-error <?php endif; ?>">
                  <label for="email">Email</label>
                  <input type="email" class="form-control" value="<?php echo e($user->email); ?>" id="email" name="email">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibip\resources\views/auths/users/edit.blade.php ENDPATH**/ ?>