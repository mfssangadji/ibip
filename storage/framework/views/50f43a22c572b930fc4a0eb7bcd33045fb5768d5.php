  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          ...
          <nav class="nav nav-masthead justify-content-center">
            ...
            <?php else: ?>
              <a class="nav-link" href="<?php echo e(route('registrasi')); ?>">Registrasi</a>
              <a class="nav-link" href="<?php echo e(route('ulogin')); ?>">Login</a>
            <?php endif; ?>
      ...
      <main role="main" class="inner cover">
        ...
        <img src="<?php echo e(asset('logo.png')); ?>" style="width: 300px; border-radius: 50px;">
      </main>
...
<?php /**PATH C:\xampp\htdocs\ibip\resources\views/welcome.blade.php ENDPATH**/ ?>