...
<?php $__env->startSection('stitle', 'Pengguna'); ?>
        ...
        <div class="col-xs-12">
        	<div class="box">
	            <div class="box-header">
	              <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary pull-left">Tambah Data</a>
	            </div>
	            <!-- /.box-header -->
	            <div class="box-body">
    ...
    $(document).ready(function() {
        ...
        var table = $('#datapost').DataTable({
            ...
            columns: [
                ...
                {data: 'email', className: 'details-control', name: 'email'},
        ...
        $('#datapost').on('click', 'a.edit', function (e) {
            ...
            window.location="<?php echo e(route('users')); ?>/"+id+"/edit";
        });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibip\resources\views/auths/users/index.blade.php ENDPATH**/ ?>