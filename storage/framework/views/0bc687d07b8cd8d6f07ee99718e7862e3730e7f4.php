  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <p class="lead">Lengkapi form registrasi dibawah ini untuk melakukan pendaftaran peserta</p>
      </div>
          ...
          <form method="post" action="" class="needs-validation" novalidate>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" required id="name" name="name" placeholder="" value="" required>
                <div class="invalid-feedback">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" required id="no_siswa" name="no_siswa" placeholder="" value="" required>
                <div class="invalid-feedback">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="email" class="form-control" required id="email" name="email" placeholder="you@example.com" value="" required>
                <div class="invalid-feedback">
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                <input id="gedung" name="stayon" type="radio" value="gedung" class="custom-control-input" required>
                <label class="custom-control-label" for="gedung">Gedung D</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="mess" name="stayon" type="radio" value="mess" class="custom-control-input" required>
                <label class="custom-control-label" for="mess">Mess Putra</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="gedung_flat" name="stayon" type="radio" value="gedung_flat" class="custom-control-input" required>
...
<?php /**PATH C:\xampp\htdocs\ibip\resources\views/registrasi.blade.php ENDPATH**/ ?>