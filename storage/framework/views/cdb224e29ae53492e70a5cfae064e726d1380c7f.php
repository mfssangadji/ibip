...
<?php $__env->startSection('content'); ?>
   ...
   <div class="col-md-12">
      ...
      <div class="box box-primary">
         ...
         <!-- /.box-header -->
         <!-- form start -->
         <form role="form" method="POST" action="<?php echo e(route('kepel')); ?>">
            <?php echo csrf_field(); ?>
            <div class="box-body">
               <div class="form-group <?php if($errors->has('kepel')): ?> has-error <?php endif; ?>">
                  <label for="name">Nama Kegiatan dan Pelatihan</label>
                  <input type="text" class="form-control" value="<?php echo e(old('kepel')); ?>" required id="kepel" name="kepel">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibip\resources\views/auths/kepel/create.blade.php ENDPATH**/ ?>