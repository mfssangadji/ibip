...
<html>
   <head>
      ...
      <title>Cpanel - @yield('title') @yield('stitle')</title>
      ...
      <!-- Daterange picker -->
      <link rel="stylesheet" href="{{asset('admin/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}"><!-- DataTable -->
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  @yield('title')
                  <small>@yield('stitle')</small>
               </h1>
               <ol class="breadcrumb">
                  <li><a href="{{route('dashboard')}}"><i class="fa fa-home"></i> Beranda</a></li>
                  <li class="active">@yield('title') @yield('stitle')</li>
               </ol>
            </section>
            <!-- Main content -->
